...
Install the published v0.6.0 release with `brew install niklas-heer/tap/kipferl`.
...
Current source validation on 2026-09-05 (see
[the generated compatibility report](tests/compat_report_pocketpy.md)):
