...
fn main() {
    ...
    let filename = match (operating_system.as_str(), architecture.as_str()) {
        ("macos", "aarch64") => "pocketpy-kipferl-macos-aarch64",
        ("macos", "x86_64") => "pocketpy-kipferl-macos-x86_64",
        ("linux", "aarch64") => "pocketpy-kipferl-linux-aarch64",
        ("linux", "x86_64") => "pocketpy-kipferl-linux-x86_64",
