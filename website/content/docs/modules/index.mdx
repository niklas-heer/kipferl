...
The following behavior is included in the published v0.7.0-rc.1 runtime. Stable
v0.6.0 predates these changes. The candidate also changes dynamic dotted imports
to return their root by default; see the [upgrade notes](/docs/guides/packages#upgrade-to-070-rc1).
