...
The following behavior describes the current source implementation. Published
v0.6 binaries and the CLI's checked-in runtime assets may predate these changes;
see [runtime development and embedded assets](/docs/guides/development#change-runtime-code-and-embedded-assets-deliberately).
