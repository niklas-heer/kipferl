...
The [compatibility guide](/docs/guides/package-audit) starts with verified
workflows, explicit limits, and a ranked list of future support priorities.
The broader audit supplies source and metadata findings. Verified syntax failures add
