...
system Python installation in **Kipferl 0.7.1**.
...
With the v0.7.1 CLI and a project, install the exact version:
...
`v0.7.1`. Homebrew users can run `brew update` and `brew upgrade kipferl`;
...
upgrading from 0.6 or any earlier 0.7 build, including 0.7.0 to 0.7.1.
