...
Universal builds automatically select a tree-shaken core runtime or the full
compatibility runtime from your imports. This happens without a local Rust
toolchain. See the [`kipferl build` reference](/docs/commands/build) for size
expectations, profile selection, cross-target behavior, and `--full-runtime`.
...
<Cards>
  ...
  <Card title="Standalone builds" href="/docs/commands/build" />
</Cards>
