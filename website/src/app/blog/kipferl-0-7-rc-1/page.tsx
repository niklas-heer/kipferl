    ...
    <main className="min-h-screen px-6 py-16 md:py-24">
      <article className="max-w-4xl mx-auto">
        ...
        <aside className="mb-14 rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-6 text-gray-700 dark:text-gray-300">
          <strong>This is a prerelease.</strong> Homebrew and GitHub’s latest
          stable release remain on v0.6.0. Follow the{" "}
          <Link
            className="text-cyan-600 dark:text-cyan-400 underline"
            href="/docs/getting-started/installation#release-candidate"
          >
            RC installation guide
          </Link>{" "}
          to verify a download and keep your stable installation available.
        </aside>
...
print(urls.quote("hello world"))`}</code>
          ...
          <p>
            Follow the{" "}
            <Link href="/docs/guides/packages#upgrade-to-070-rc1">
              upgrade notes
            </Link>{" "}
          ...
          <p>
            Use the{" "}
            <Link href="/docs/getting-started/installation#release-candidate">
              installation guide
            </Link>{" "}
            for checksum commands and a separate RC installation. Then try the
            candidate with your project and report reproducible problems through{" "}
